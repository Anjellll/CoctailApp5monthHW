...
final class NetworkLayer {
    ...
    func fetchDataByLetter(by letter: String) async throws -> Coctails {
    ...
    func fetchCoctails() async throws -> Coctails {
        var coctailsArray = Coctails(drinks: [])
